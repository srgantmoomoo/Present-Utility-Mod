...
import net.minecraft.client.gui.GuiButtonRainbow;
import net.minecraft.client.gui.GuiScreen;

public class ClickGuiRainbow extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawRect(130, 2, 215, 14, 0x80000000);
		mc.fontRendererObj.drawString("Combat", 156, 4, color); //0xffffffff
		drawRect(230, 2, 315, 14, 0x80000000);
		drawRect(230, 2, 315, 14, 0x80000000);
		mc.fontRendererObj.drawString("Movement", 250, 4, color);
		drawRect(330, 2, 415, 14, 0x80000000);
		drawRect(330, 2, 415, 14, 0x80000000);
		mc.fontRendererObj.drawString("Render", 354, 4, color);
		drawRect(430, 2, 515, 14, 0x80000000);
		drawRect(430, 2, 515, 14, 0x80000000);
		mc.fontRendererObj.drawString("Player", 455, 4, color);
